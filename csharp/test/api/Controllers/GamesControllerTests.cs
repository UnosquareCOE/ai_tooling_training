...
public class GamesControllerTests
{
    ...
    public void GetGame_WhenGameExists_ReturnsGame()
    {
        ...
        _mapper.Map<MakeGuessResponseViewModel>(gameDto).Returns(new MakeGuessResponseViewModel
        {
            ...
            AttemptsRemaining = 5,
            Guesses = [],
            Status = GameStatuses.InProgress.ToString()
        });
    ...
    [Fact]
    public void MakeGuess_WhenGameExistsAndValidGuess_ReturnsUpdatedGame()
    {
        var newId = Guid.NewGuid();
        var gameDto = new GameDto
        {
        ...
        var response = gamesController.MakeGuess(newId, guess);
    ...
    [Fact]
    public void MakeGuess_WhenGameExistsAndInvalidGuess_ReturnsUpdatedGame()
    {
        var newId = Guid.NewGuid();
        var gameDto = new GameDto
        {
